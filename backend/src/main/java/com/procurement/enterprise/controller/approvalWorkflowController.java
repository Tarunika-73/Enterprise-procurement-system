...
@RestController
@RequestMapping({"/v1/approval-workflow", "/approval-workflow"})
...
public class ApprovalWorkflowController {
     ...
     *
     * POST /api/approval-workflow/approve (also mounted at /api/v1/approval-workflow/approve)
     */
    @PostMapping("/approve")
     ...
     *
     * POST /api/approval-workflow/reject (also mounted at /api/v1/approval-workflow/reject)
     */
    @PostMapping("/reject")
     ...
     *
     * GET /api/approval-workflow/pending/{approverId} (also mounted at /api/v1/approval-workflow/pending/{approverId})
     */
     ...
     *
     * GET /api/approval-workflow/approver/{approverId} (also mounted at /api/v1/approval-workflow/approver/{approverId})
     */
     ...
     *
     * GET /api/approval-workflow/status/{requestId} (also mounted at /api/v1/approval-workflow/status/{requestId})
     */
     ...
     *
     * GET /api/approval-workflow/health (also mounted at /api/v1/approval-workflow/health)
     */
    @GetMapping("/health")
