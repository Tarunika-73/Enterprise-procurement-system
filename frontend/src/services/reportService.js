...
/**
 * Downloads the current, role-scoped Reports page data as a formatted spreadsheet and
...
export const downloadReport = async () => {
  ...
  let filename = `EPS_Procurement_Report_${new Date().toISOString().slice(0, 10)}.xls`;
